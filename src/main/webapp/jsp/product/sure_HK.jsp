...
<script type="text/javascript">
	...
	function sure_HK(){
		...
		var hkno = $("#hkno").html();
		if(return_money == null || return_money == ""){
			...
			<div class="panel panel-default" style="width: 100%;">
				<ul id='list_ul' class="list-group">
					...
					<li class="list-group-item item_border"
						...
						id="return_money" name="return_money" oninput="qianfenwei('return_money')">
					</li>
					<li class="list-group-item item_border"
						style="border-top: 1px solid #ddd;">回款日期：
                    	<span style="margin-right: 4px;"><input id="return_date" class="form_datetime" maxlength="20" type="text" style="border: none; width: 90%; color: #333; outline: none;">
						</span>
						<!--  <input type="number"
						style="border: none; width: 90%; color: #333; outline: none;"
	...
	<%-- 	<div class="panel panel-default" id="sale_rtn"
			...
			<div class="panel panel-default" style="width: 100%;">
				<ul id='list_ul' class="list-group">
					<li class="list-group-item"
						...
						<h3 class="panel-title" style="color: #a52410;">
							<span class="glyphicon glyphicon-th" aria-hidden="true"
								style="margin-right: 6px;"></span>项目发布回款
						</h3>
					</li>
					<li class="list-group-item item_border"
					...
					<li class="list-group-item item_border"
						...
						type="number"
						style="border: none; width: 90%; color: #333; outline: none;"
						id="s_return_money" name="s_return_money">
					</li>
					<li class="list-group-item item_border"
		...
		<div class="row text-center">
			<button style="margin-right: 40px;" data-dismiss="modal"
				class="btn btn-lg btn-default" onclick="cancel_HK()">取消</button>
			<button class="btn btn-lg" data-dismiss="modal"
				style="background-color: #5bc0de; color: #fff;" onclick="sure_HK()">确定</button>
		</div>
</body>
</html>