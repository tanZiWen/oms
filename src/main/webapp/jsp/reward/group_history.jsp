...
<div class="col-md-4 myleft" style="width: 25%;">
 ...
 --%>
    ...
    <div class="df"></div>
           ...
           <%--  <tr>
            <td>${rewardList.group_id }</td>
            <td>${rewardList.name }</td>
             <td>${rewardList.sales_name }</td>
            <td>${rewardList.reward_batch_id }</td>
            <td>${rewardList.order_no }</td>
            <td>${rewardList.goal_per }</td>
            <td>${rewardList.reward_return }</td>
            <td>已计算</td>
            </tr> --%>
            <s:if test="#request.status==1 ">
				<s:iterator value="#request.rewardList" var="rewardLi">
				 <tr>
                    <td>${rewardLi.group_id }</td>
                    <td>${rewardLi.name }</td>
                    <td>${rewardLi.sales_name }</td>
                    <td>${rewardLi.reward_batch_id }</td>
                    <td>${rewardLi.order_no }</td>
                    <td>${rewardLi.goal_per }</td>
                    <td>${rewardLi.reward_return }</td>
                    <td>${rewardLi.stateflag }</td>
                    </tr>
				</s:iterator>
			</s:if>
            </tbody>
